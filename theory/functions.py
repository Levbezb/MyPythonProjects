...
def get_powers(num):                # Эта фунция возвращает 2, 3 и 4 степень числа
    return num**2, num**3, num**4   # как мы видим возвращать можно сразу несколько значений

# Чтобы возвращение нескольких значений работало правильно, нужно их всех присвоить в какие нибудь переменные, иначе возникнет ошибка
a, b, c = get_powers(4)
